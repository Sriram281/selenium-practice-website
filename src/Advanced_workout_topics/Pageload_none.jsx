...
import inputtext_box from "./image_for_Answer/page_load_none.png";
...
const Pageload_none = () => {
  ...
  const [heading, setHeading] = useState("Pageload strategy 'NONE'");
  useEffect(() => {
    ...
    // Simulate fetching dynamic content after loading
    const contentTimer = setTimeout(() => {
      setDynamicContent(
        <>
          <div>
            <h5>'This content was dynamically loaded!'</h5>
            <div className="">
              <div className="row">
        ...
        <div className="row">
          ...
          <div className="d-flex justify-content-around  col-sm-6">
            ...
            <div style={{ cursor: "pointer" }}>
              <a
                href="https://onedrive.live.com/?authkey=%21AGRfN9O0p96AUn8&cid=58854C9B9741551E&id=58854C9B9741551E%2145829&parId=58854C9B9741551E%2145819&o=OneUp"
                target="box"
              >
        ...
        <div className="container p-4" style={{}}>
          <div className="container p-2 collapse" id="demo">
            ...
            >
              ...
              >
                <li>
                  The third page has a slow loading time due to dynamic content.
                  Use the none page load strategy and incorporate explicit waits
                  to handle the dynamic elements on the page.
                </li>
                <li>
          ...
          <div className="container p-2">
            ...
            >
              ...
              >
                Does not wait htmlFor the page to load. Allows the user to
                decide when to proceed, useful htmlFor handling dynamic content
          ...
          <div className="row">
            <div className="col-sm-7 p-3 text-black">
              <div className="element-card">
                <h3 id="page_3">Page 3 (Slow Load with Dynamic Content)</h3>
                {loading ? (
                  <p>Loading...</p>
                ) : (
                  <div>
                    <p>This page has slow loading time.</p>
                    <p>{dynamicContent}</p>
                  </div>
                )}
              </div>
            ...
            <div className="col-sm-5 p-3 text-black">
              <div className="element-card">
                <header>
                  ...
                  >
                    " Explore the power of 'PageLoadStrategy.NONE' in this
                ...
                <div className="list">
                  ...
                  >
                    <li>
                      <pre>setPageLoadStrategy(PageLoadStrategy.NONE)</pre>
                    </li>
                    <li>getText()</li>
                    <li>findElement()</li>
                    <li>sendKeys()</li>
