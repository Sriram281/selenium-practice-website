...
import inputtext_box from "./image_for_Answer/page_load_normal.png";
...
const Pageload_normal = () => {
  var nav = useNavigate();
  const storage = window.localStorage.getItem("studentID");
  const [heading, setHeading] = useState("Pageload strategy 'NORMAL'");
  return (
    <>
      <Header />
        ...
        <div className="row">
          ...
          <div className="d-flex justify-content-around  col-sm-6">
            ...
            <div style={{ cursor: "pointer" }}>
              <a
                href="https://onedrive.live.com/?authkey=%21AGRfN9O0p96AUn8&cid=58854C9B9741551E&id=58854C9B9741551E%2145822&parId=58854C9B9741551E%2145819&o=OneUp"
                target="box"
              >
        ...
        <div className="container p-4" style={{}}>
          <div className="container p-2 collapse" id="demo">
            ...
            >
              ...
              >
                <li>
                  The first page loads quickly, and you can use the default page
                  load strategy.
                </li>
                <li>
          ...
          <div className="container p-2">
            ...
            >
              ...
              >
                This is the default strategy, where Selenium WebDriver waits
                htmlFor the full page to load before moving on to the next
                commands.
              </p>
            </div>
          </div>
          <div className="row">
            <div className="col-sm-7 p-3 text-black">
              <div className="element-card">
                <h3 id="page_1">Page 1 (Fast Load)</h3>
                <h5>This page loads quickly!</h5>
                <div className="row">
            ...
            <div className="col-sm-5 p-3 text-black">
              <div className="element-card">
                <header>
                  ...
                  >
                    " Explore the power of 'PageLoadStrategy.NORMAL' in this
                ...
                <div className="list">
                  ...
                  >
                    <li>
                      <pre>setPageLoadStrategy(PageLoadStrategy.NORMAL)</pre>
                    </li>
                    <li>getText()</li>
                    <li>findElement()</li>
                    <li>sendKeys()</li>
...
export default Pageload_normal;
const styles = {
  one: {
    padding: "5px",
  },
