...
import inputtext_box from "./image_for_Answer/practice_form.png";
...
const Practice_form = () => {
  ...
  const [heading, setHeading] = useState("Practice_form");
  useEffect(() => {
    try {
  ...
  const navigate_to_Form_list = () => {
    nav("/form_list", { state: { myData: list } });
  };
        ...
        <div className="container p-4" style={{}}>
          <div className="container p-2">
            ...
            >
              ...
              >
                "Effortlessly collect user information with our intuitive form.
                Streamline data input, enhance user interaction, and simplify
                feedback. Elevate your website experience with our user-friendly
                form component."
              </p>
            </div>
          </div>
            ...
            <div className="col-sm-5 p-3 text-black">
              <div className="element-card">
                <header>
                  ...
                  >
                    " Explore the power of 'Form' in this Selenium practice
