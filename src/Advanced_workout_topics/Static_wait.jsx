...
import inputtext_box from "./image_for_Answer/static_wait.png";
...
const Static_wait = () => {
  ...
  const [heading, setHeading] = useState("Static wait");
  return (
    <>
      <Header />
        ...
        <div className="row">
          ...
          <div className="d-flex justify-content-around  col-sm-6">
            ...
            <div style={{ cursor: "pointer" }}>
              <a
                href="https://onedrive.live.com/?authkey=%21AGRfN9O0p96AUn8&cid=58854C9B9741551E&id=58854C9B9741551E%2145052&parId=58854C9B9741551E%218719&o=OneUp"
                target="box"
              >
        ...
        <div className="container p-4" style={{}}>
          <div className="container p-2 collapse" id="demo">
            ...
            >
              ...
              >
                ...
                <li>
                  Introduce a static wait of 5 seconds after Entered a First
          ...
          <div className="container p-2">
            ...
            >
              ...
              >
                Static wait involves pausing the execution of the Selenium
                script for a predefined duration, regardless of whether the
                element is ready. It's a simple but less flexible approach.
              </p>
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-sm-5 p-3 text-black">
              <div className="element-card">
                <header>
                  ...
                  >
                    " Explore the power of 'Static wait' in this Selenium
